...
layout: page
title: "Architecture"
description: "Module tree, polymorphism registries, the Fused pipeline, and how attention, solver, and training compose."
permalink: "/architecture/"
---

**Audience: contributors and reviewers who want to know which file is responsible for which behaviour.**
...
## Next steps
- [Mathematical foundations](/xaker/math/) — derivations matching the implementation byte-for-byte.
- [API reference](/xaker/api/) — every public symbol and its signature.
