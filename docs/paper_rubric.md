...
layout: page
title: "Paper rubric"
description: "The six-dimension paper-worthiness rubric enforced in CI: novelty, repro, correctness, efficiency, stability, usability."
permalink: "/paper_rubric/"
---

**Audience: maintainers and reviewers who run `xaker-validate`.**
...
## Next steps
- [Troubleshooting](/xaker/troubleshooting/) — what to do when the rubric gate fails.
- [Contributing](/xaker/contributing/) — how contributors keep the gate at 17/18.
