...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--kind", choices=sorted(BLOCK.keys()), default="fused",
                        help="Attention variant the saved checkpoint used.")
    ...
    cfg = Config(dim=args.dim, heads=args.heads)
    model = Model(
        cfg,
